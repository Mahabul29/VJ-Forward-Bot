...
main_buttons = [[
    InlineKeyboardButton('❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ ❣️', url='https://t.me/Mahabul201')
],[
    InlineKeyboardButton('🔍 ᴀɴɪᴍᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/Hindi_Dub_Animes_Official'),
    InlineKeyboardButton('🤖 ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/Hindi_Dub_Netflix_Movies')
],[
